---
title: Web garden
publishDate: '2011-02-07T16:27:00'
excerpt: 'Par défaut, une application Web est représentée par un seul processus dit Worker Process. Toutes les requêtes clientes reçues par IIS sont acheminées vers le Worker Process par le noyau http.sys. Les requêtes sont alors '
image: /generated-covers/web-garden.svg
author: evilz
tags:
- IIS
- Informatique
