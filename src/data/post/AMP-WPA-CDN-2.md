...
excerpt: 'Cet article est le second de la série dédiée aux retours d''expérience sur le sujet : Obtenir un site performant avec Accelerated Mobile Page, Progressive Web App et un content delivery network'
